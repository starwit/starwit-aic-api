...
class ActionEntity(BaseModel):
    ...
    decision: Optional[DecisionEntity] = None
    action_type: Optional[ActionTypeEntity] = Field(default=None, alias="actionType")
    __properties: ClassVar[List[str]] = ["id", "creationTime", "name", "description", "decision", "actionType"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "decision": DecisionEntity.from_dict(obj["decision"]) if obj.get("decision") is not None else None,
            "actionType": ActionTypeEntity.from_dict(obj["actionType"]) if obj.get("actionType") is not None else None
        })
        return _obj
...
ActionEntity.model_rebuild(raise_errors=False)
