...
class DecisionEntity(BaseModel):
    ...
    acquisition_time: Optional[datetime] = Field(default=None, alias="acquisitionTime")
    ...
    decision_type: Optional[DecisionTypeEntity] = Field(default=None, alias="decisionType")
    action: Optional[List[ActionEntity]] = None
    __properties: ClassVar[List[str]] = ["id", "acquisitionTime", "mediaUrl", "cameraLatitude", "cameraLongitude", "state", "description", "decisionType", "action"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "decisionType": DecisionTypeEntity.from_dict(obj["decisionType"]) if obj.get("decisionType") is not None else None,
...
DecisionEntity.model_rebuild(raise_errors=False)
